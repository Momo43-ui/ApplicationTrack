            ...
            <div className="p-4 border-t border-gray-200">
              <div className="flex gap-2">
                <input
                  ...
                  disabled={loading}
                  className="flex-1 px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:opacity-50"
                />
                <button
                  onClick={handleSend}
